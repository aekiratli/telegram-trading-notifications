...
import { useFetchCoins, useFetchSymbols, useFetchChannels } from "../api/queries";
  ...
  return (
    <Box sx={{ maxWidth: 600, mx: "auto", p: 3 }}>
      ...
      <Box display="flex" justifyContent="space-between" p={1}>
        ...
        <Button startIcon={<Edit />} onClick={handleOnSave} disabled={isSaveDisabled} type="submit" variant="contained">
          Save Symbols
        </Button>
      </Box>
      <Select
      ...
      <Box display="flex" justifyContent="space-between" p={1}>
        ...
        <Button onClick={() => (setIsAddChannelDialogOpen(true))} variant="contained" startIcon={<Add />} color="primary">
          Add Channel
        </Button>
      </Box>
      <TableContainerStyled>
        <Table>
          ...
          {
            isChannelDataLoading ? <ChannelTableSkeleton/> :
              <TableBody>
      ...
      <AddDialog open={isAddChannelDialogOpen} setOpen={setIsAddChannelDialogOpen} />
      <DeleteDialog open={isDeleteChannelDialogOpen} setOpen={setIsDeleteChannelDialogOpen} channel={channel} />
    </Box>
  );
};
